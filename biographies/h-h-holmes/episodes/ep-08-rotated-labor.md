...
graph TD
    A["បញ្ជាទិញដែកថែប & ទូដែកសុវត្ថិភាពខ្ចីលុយ<br/>Ordering Steel & Vault on Credit"] --> B["ដំឡើងគ្រឿងបង្គុំជាប់នឹងរចនាសម្ព័ន្ធអគារ<br/>Structural Installation & Integration"]
    B --> C["ខកខានការទូទាត់ប្រាក់ (Default)<br/>Defaulting on Invoices & Checks"]
    C --> D["ក្រុមហ៊ុនផ្គត់ផ្គង់ប្តឹងទារប្រាក់ / ដោះសម្ភារៈ<br/>Suppliers Sue & Demand Reclamation"]
    D --> E["គំរាមប្តឹងត្រឡប់ថ្លៃខូចខាតអគារ<br/>Counter-Threatening with Property Damage Suits"]
    E --> F["រំលាយក្រុមហ៊ុនខ្យល់ចាស់ បង្កើតក្រុមហ៊ុនថ្មី<br/>Dissolving Shell Company & Transferring Assets"]
    F --> G["ពន្យារពេលបណ្តឹងតាមប្រព័ន្ធតុលាការយឺតយ៉ាវ<br/>Civil Court Backlog delays Creditor Recovery"]
    G --> H["ប្រមូលផលចំណេញហិរញ្ញវត្ថុឥតគិតថ្លៃ<br/>Accumulating Free Physical Capital for Castle"]
    H --> A
